...
int MS_ReaderReadPage(struct us_data *us, DWORD PhyBlockAddr, BYTE PageNum, PDWORD PageBuf, MS_LibTypeExtdat *ExtraDat)
{
	...
	ExtraDat->reserved = 0;
	ExtraDat->intr     = 0x80;  // Not yet, ˇ安ˇ, 单 fireware support
	ExtraDat->status0  = 0x10;  // Not yet, ˇ安ˇ, 单 fireware support
	ExtraDat->status1  = 0x00;  // Not yet, ˇ安ˇ, 单 fireware support
